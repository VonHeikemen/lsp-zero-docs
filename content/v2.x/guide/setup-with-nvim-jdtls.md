...
* [lsp-zero (v2.x)](https://github.com/VonHeikemen/lsp-zero.nvim/tree/v2.x)
...
We will use the function [.skip_server_setup()](../reference/lua-api#skip-server-setup-list) to make sure lsp-zero doesn't initialize jdtls.

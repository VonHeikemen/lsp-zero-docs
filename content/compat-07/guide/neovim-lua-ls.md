...
If your Neovim config is the only lua project you have in your system, use the function [.nvim_lua_ls()](../reference/lua-api#nvim-lua-ls-opts) to get the config and then setup `lua_ls` with lspconfig.
